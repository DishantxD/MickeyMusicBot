...
START_BUTTON_GROUP = InlineKeyboardMarkup(
    [   
        ...
        [
            InlineKeyboardButton(
                text="📣 Updates Channel", url="https://t.me/MickeyxOfficial"
            ),
            InlineKeyboardButton(
                text="💬 Support Group", url="https://t.me/littlecupids"
            ),                       
        ],
        [
            InlineKeyboardButton(
                text="🔗 Deploy your own bot", url="https://github.com/DishantxD"
            ),                                  
        ]
    ]
)
